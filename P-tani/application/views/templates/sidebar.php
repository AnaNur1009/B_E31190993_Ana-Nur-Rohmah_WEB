  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">TOKO P-Tani</div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url('dashboard1/')?>">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('jenis/organik/')?>">
          <i class="fas fa-carrot"></i>
          <span>Organik</span></a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('jenis/non_organik/')?>">
          <i class="fas fa-seedling"></i>
          <span>Non Organik</span></a>
      </li>
