<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8">
			...
			<form method="post" action="<?php echo base_url()?>dashboard1/proses_pesanan">
				...
				<div class="form-group mt-3">
					...
					<input type="teks" name="metode" placeholder="Transfer" class="form-control">

				<div class="form-group">
					<button type="submit" class="btn btn-sm btn-primary mb-3 mt-3">Pesan</button>
					<?php echo anchor('dashboard1/cod/', '<div class="btn btn-sm btn-danger ml-4">COD</div>') ?>
				</div>
