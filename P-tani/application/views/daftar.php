  ...
  <div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block "><img src="<?php echo base_url('uploads/logoPtani.png')?>" width="500px" align="text-center"></div>
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">FORM DAFTAR OWNER</h1>
              </div>
              <form method="post" action="<?php echo base_url('daftar/index')?>" class="user">
               <div class="form-group">
                ...
                <div class="form-group">
                  <input type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Masukan Alamat Email Anda" name="email">
